document.getElementById('uploadForm').onsubmit = async function(event) {
  ...
  if (fileInput.files.length > 0) {
    ...
    try {
      ...
      swfContainer.innerHTML = `<object data="https://supreme-space-computing-machine-wrgjw9prp79ph5995-3000.app.github.dev/uploads/${file.name}" class="full" id="myObject" width="800" height="600"></object>`;
    } catch (error) {
